...
class Workspace(Base):
    ...
    plan: Mapped[Plan] = mapped_column(Enum(Plan), nullable=False, server_default=text("'free'"))
...
class ApiKey(Base):
    ...
    status: Mapped[ApiKeyStatus] = mapped_column(Enum(ApiKeyStatus), nullable=False, server_default=text("'active'"))
...
class Render(Base):
    ...
    status: Mapped[RenderStatus] = mapped_column(Enum(RenderStatus), nullable=False, server_default=text("'queued'"))
