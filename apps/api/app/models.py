...
class Workspace(Base):
    ...
    subscription: Mapped[Subscription | None] = relationship("Subscription", back_populates="workspace", uselist=False, cascade="all, delete-orphan")
...
class Render(Base):
    ...
    extra_metadata: Mapped[dict[str, Any] | None] = mapped_column(JSON, name="extra_metadata", nullable=True)
    created_at: Mapped[datetime] = mapped_column(nullable=False, server_default=func.now())
...
class WebhookEndpoint(Base):
    ...
    events: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=lambda: ["render.succeeded", "render.failed"])
